        ...
        b_zufall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (theRoll2 == theRoll1){
                    ...
                    Toast.makeText(Main2Activity.this, "Unentschieden ", Toast.LENGTH_SHORT).show();
                ...
                if (theRoll1 > theRoll2){
                    ...
                    Toast.makeText(Main2Activity.this, "Spieler1 gewinnt. ", Toast.LENGTH_SHORT).show();

                } else
                    tv_ergebniss.setText("Spieler2 gewinnt.");
                    ausgabe="Spieler2 gewinnt.";
                Toast.makeText(Main2Activity.this, "Spieler2 gewinnt. ", Toast.LENGTH_SHORT).show();
